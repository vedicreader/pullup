...
# %% auto #0
__all__ = ['DEPLOY_FILE', 'GENERATOR', 'DeployError', 'DEPLOY_KEYS', 'DEPLOY_STEPS', 'setup_template', 'deploy_template',
           'Deploy']

# %% ../nbs/03_deploy.ipynb #d7cc8469
import os
...
# %% ../nbs/03_deploy.ipynb #68232d34
#: Who the generated `setup.py` and `deploy.py` say wrote them. A host that puts its own name
#: on what it generates sets `$PULLUP_GENERATOR`.
GENERATOR = os.environ.get('PULLUP_GENERATOR') or 'pullup'
