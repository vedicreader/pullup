...
# %% ../nbs/04_drive.ipynb #3ae477dd
from __future__ import annotations

# %% auto #0
__all__ = ['DRIVE_FILE', 'DriveError', 'PARTS', 'Part', 'context', 'parts', 'Drive']

# %% ../nbs/04_drive.ipynb #90d32c84
import json, sys

# %% ../nbs/04_drive.ipynb #c871cc4f
from dataclasses import dataclass, field

# %% ../nbs/04_drive.ipynb #1e006821
from pathlib import Path

# %% ../nbs/04_drive.ipynb #266e9b8a
from .env import EnvStore

# %% ../nbs/04_drive.ipynb #b652ce73
from .env import env_value

# %% ../nbs/04_drive.ipynb #f1ced85b
from .pipeline import DIR, Pipeline, PipelineError

# %% ../nbs/04_drive.ipynb #987b61f5
from .project import Step

# %% ../nbs/04_drive.ipynb #23ff4344
DRIVE_FILE = 'drive.json'

# %% ../nbs/04_drive.ipynb #cd7d52b1
DriveError = PipelineError

# %% ../nbs/04_drive.ipynb #3ab3ed04
@dataclass
class Part:
