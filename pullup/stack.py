...
# %% ../nbs/07_stack.ipynb #ca08b2e0
from __future__ import annotations

# %% auto #0
__all__ = ['FAMILY', 'installed', 'checkout_for', 'survey', 'frames', 'blame']

# %% ../nbs/07_stack.ipynb #17512eca
import re

# %% ../nbs/07_stack.ipynb #3da67557
from pathlib import Path

# %% ../nbs/07_stack.ipynb #585f8f8f
from fastcore.basics import first, ifnone

# %% ../nbs/07_stack.ipynb #473d7e6e
...
# %% ../nbs/07_stack.ipynb #e696f556
_FRAME = re.compile(r'File "([^"]+)", line (\d+), in (\S+)')

# %% ../nbs/07_stack.ipynb #03591da1
def installed(name):
...
# %% ../nbs/07_stack.ipynb #c6c56e7f
def _version(name):
    from importlib import metadata
    try: return metadata.version(name)
    except Exception: return ''

# %% ../nbs/07_stack.ipynb #42e615d5
def _vendored(path):
