...
# %% ../nbs/05_workflows.ipynb #77b85d19
from __future__ import annotations

# %% auto #0
__all__ = ['WORKFLOW_DIR', 'WorkflowError', 'levels', 'Workflows']

# %% ../nbs/05_workflows.ipynb #321cda7a
import re

# %% ../nbs/05_workflows.ipynb #2be54aaa
from shutil import which

# %% ../nbs/05_workflows.ipynb #d95733a7
from fastcore.all import Path, first

# %% ../nbs/05_workflows.ipynb #16140ce0
from .stack import installed

# %% ../nbs/05_workflows.ipynb #86b97b82
WORKFLOW_DIR = '.github/workflows'

# %% ../nbs/05_workflows.ipynb #9e7f7b21
class WorkflowError(RuntimeError):
    pass

# %% ../nbs/05_workflows.ipynb #ee0adf97
def _gheasy():
    try:
...
# %% ../nbs/05_workflows.ipynb #5a74f1e4
def _yaml():
...
# %% ../nbs/05_workflows.ipynb #2a49dad8
class Workflows:
...
# %% ../nbs/05_workflows.ipynb #0fb0799b
...
# %% ../nbs/05_workflows.ipynb #bbe2932a
...
# %% ../nbs/05_workflows.ipynb #7bdc6b7e
def _gh_authed():
...
# %% ../nbs/05_workflows.ipynb #6a54a210
def _run_row(run):
...
# %% ../nbs/05_workflows.ipynb #2581ed9e
def _read(path):
...
# %% ../nbs/05_workflows.ipynb #32377c44
def _wf_file(run):
...
# %% ../nbs/05_workflows.ipynb #a5be0a2f
def _from_line(text):
...
# %% ../nbs/05_workflows.ipynb #69161a69
def _wf_name(name):
